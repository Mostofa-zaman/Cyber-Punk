...
const Dive = () => {
  return (
   <section className='bg-[#0B0B0B]  text-white  border-t-2 border-amber-600 pb-[100px]'>
     <div className='max-w-[1320px] mx-auto relative dive'>
       <div>
        ...
        <div className="divebgimg">
          <div className='pl-[45px] pb-[90px]  pt-[170px] flex'>
            <div >
              <h2 className='text-[68px] leading-20 w-[640px]  font-bold'>Greetings! Dive into  the Cybernetic Universe</h2>
            ...
            <div className='pt-20 pl-50'> 
               <div className='border py-14 px-[50px] bg-[#ffffff49] border-[#F0B71F] rounded-[5px]'>
                 <ul className='flex flex-col gap-y-7'>
                   <li className='flex gap-5 text-[25px] items-center'><div className='h-5 w-5 bg-amber-500'></div>Join the Revolution </li>
                   <li className='flex gap-5 text-[25px] items-center'><div className='h-5 w-5 bg-red-500'></div>Art and Design</li>
                   <li className='flex gap-5 text-[25px] items-center'><div className='h-5 w-5 bg-amber-500'></div>Tech and Gear</li>
                   <li className='flex gap-5 text-[25px] items-center'><div className='h-5 w-5 bg-red-500'></div>Stories and Lore</li>
